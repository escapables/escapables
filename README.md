...
- **[ordning](https://github.com/escapables/ordning)** — Portable offline calendar for Linux. Apple Calendar-inspired weekly view, local-only JSON storage, optional AES-256-GCM encryption, recurring events, and single-file AppImage deployment. Built with Tauri v2.
