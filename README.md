...
I don't give agency to the AI beyond limited scopes depending on the context. That means I give the computer a specific task to iterate on until the source code reaches a point of stability/security/effectivity that I can sign off on. I cannot write code but I can read and understand it and know when it produces a program that is good or bad. Sort of like Rick Rubin but for computers. 
I design all my commits manually and then outsource all the manual labor to the Codex factory, and when that code comes back I close my eyes, massage my toes, and make a Decision, and in the end there is good software (well, good enough for my purposes and they work the way I want them to without any issues). If you don't believe me check out my MOTIS fork further down below.
